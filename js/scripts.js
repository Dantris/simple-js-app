document.addEventListener("DOMContentLoaded", function () {
  ...
  const modalAbilities = document.getElementById("modalAbilities"); // Added initialization
  const closeButton = document.getElementById("closeButton");
  const searchInput = document.getElementById("searchInput"); // Search input initialization
    ...
    .then((data) => {
      data.results.forEach((pokemon, index) => {
        ...
        card.addEventListener("click", async () => {
          // Capitalize the name and update modal content
          ...
          modalHeight.textContent = `Height: ${heightData.height * 10} cm`;
